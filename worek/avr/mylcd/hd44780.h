...
#define LCD_DB4_DIR		DDRE
#define LCD_DB4_PORT	PORTE
#define LCD_DB4			(1 << PE3)

#define LCD_DB5_DIR		DDRG
#define LCD_DB5_PORT	PORTG
#define LCD_DB5			(1 << PG5)

#define LCD_DB6_DIR		DDRE
#define LCD_DB6_PORT	PORTE
#define LCD_DB6			(1 << PE5)

#define LCD_DB7_DIR		DDRE
#define LCD_DB7_PORT	PORTE
#define LCD_DB7			(1 << PE4)
